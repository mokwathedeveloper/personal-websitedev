        ...
        <AnimatePresence mode="popLayout">
          {filteredProjects.map((project) => {
            ...
            return (
              ...
              >
                <SpotlightCard className="h-full flex flex-col group transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1 border-primary/10">
